...
Java_com_example_tinyearlib_WhisperEngine_createTFLiteEngine(JNIEnv *env, jobject thiz) {
...
Java_com_example_tinyearlib_WhisperEngine_loadModel(JNIEnv *env, jobject thiz, jlong nativePtr, jstring modelPath, jboolean isMultilingual) {
...
Java_com_example_tinyearlib_WhisperEngine_freeModel(JNIEnv *env, jobject thiz, jlong nativePtr) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
    engine->freeModel();
    delete engine;
}
...
Java_com_example_tinyearlib_WhisperEngine_transcribeBuffer(JNIEnv *env, jobject thiz, jlong nativePtr, jfloatArray samples) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
...
JNIEXPORT jstring JNICALL
Java_com_example_tinyearlib_WhisperEngine_transcribeFile(JNIEnv *env, jobject thiz, jlong nativePtr, jstring waveFile) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
